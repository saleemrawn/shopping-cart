...
describe("HeroBanner", () => {
  it("renders correct banner heading", () => {
    render(wrapWithProviders(<HeroBanner title="End Of Year Sales" images={{}} />));
  ...
  it("does not render banner if no title is provided", () => {
    render(wrapWithProviders(<HeroBanner images={{}} />));
  ...
  it("renders mobile image source for mobile viewports", () => {
    render(wrapWithProviders(<HeroBanner title="End of Year" images={{ desktop: "../banner-desktop.jpg", mobile: "../banner-mobile.jpg" }} />));
